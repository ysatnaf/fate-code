package info.fatecode.repository;

import info.fatecode.FatecodeApp;
import info.fatecode.config.Constants;
import info.fatecode.config.audit.AuditEventConverter;
import info.fatecode.domain.PersistentAuditEvent;
...
import static info.fatecode.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
